...
class FuturesBroker:
    ...
    def execute(self, orders: list[RollOrder], specs_by_market: dict, use_micro: bool, wait: float = 4.0):
        ...
        for o in orders:
            ...
            try:
                ...
                self.ib.sleep(wait)
                logging.info("%s %d %s %s -> %s  (%s)", o.action, o.qty, o.ib_symbol, o.expiry,
                             trade.orderStatus.status, o.reason)
            except Exception as e:  # noqa: BLE001
